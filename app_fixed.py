"""FitFinder - Clean backend (alternate entry) to run when app.py is corrupted.

This mirrors the intended app.py behavior but is written to a new file so we
can run it without modifying the existing `app.py` further.
"""
...
if __name__ == '__main__':
    print('FitFinder (alt) starting. MIRAGIC configured:', bool(os.environ.get('MIRAGIC_API_KEY')))
